  ...
  return (
    <div >
      ...
      <div className="w-full flex items-center justify-between">
        <h1 className="my-10 text-xl font-semibold" >اذكار بعد الصلاة</h1>
        <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {data["أذكار بعد السلام من الصلاة المفروضة"].map((d, index) => {
          if (Count[index] <= 0) {
            return null;
          } else
            return (
              <div className="shadow-lg rounded-md p-6" key={index}>
